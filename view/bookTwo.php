    ...
    <div class="BookVisualPresentation">
        ...
        <div class="BookInfos">
            <div class="BookProfileText">
                <h2>Au-delà du fleuve et sous les arbres</h2>
            </div>
            <div class="BookInfosText">
                <h3><strong>Date de parution :</strong> Novembre 1974</h3>
                <h3><strong>Éditeur :</strong> Folio</h3>
                <h3><strong>Format :</strong> 18cm x 22cm</h3>
                <h3><strong>Nombres de pages :</strong> 416</h3>
            </div>
            <div class="BookLogos">
